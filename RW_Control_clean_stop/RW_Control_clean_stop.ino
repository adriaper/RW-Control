 ...
 * read_IMU() and IMU setup content code extracted from Andrés Gomez and Miquel Reurer, from the PLATHON group (magnetorquers section)
 */
...
void positioning_Coarse()
{
  ...
  */
  ...
  {
    Delta_degree_ramp = Initial_IMU_degree_value - Final_IMU_degree_value; // degree turnt on acc, only in Z. Should be positive
  }
